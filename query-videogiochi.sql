...
select country, count(id) as contatore
from software_houses
group by country

--2- Contare quante recensioni ha ricevuto ogni videogioco (del videogioco vogliamo solo l'ID) (500)
select videogame_id, count(id) as number_reviews
from reviews
...
select videogame_id, videogames.name as videogame_name, category_id, categories.name as category_name
from category_videogame
...
select distinct software_house_id, software_houses.name as software_house_name, tax_id, city, country
from videogames
